...
function getRoutes()
{
    $routes['main']['linkSchema'] = '/';
    $routes['main']['method'] = ['GET'];
    $routes['main']['options']['controller'] = 'test\router\helpers\Controller::main';
    $routes['main']['options']['requirements']['regex']['page'] = '/^\d+$/';
    $routes['main']['options']['defaults']['page'] = 1;
    $routes['main']['options']['ips'][] = '::1';

    $routes['login']['linkSchema'] = '/admin/login/:system';
    $routes['login']['method'] = ['GET', 'POST'];
    $routes['login']['options']['controller'] = 'test\router\helpers\Controller::index';
    $routes['login']['options']['defaults']['system'] = 'admin';
